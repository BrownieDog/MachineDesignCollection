...
def AGMA_coefficients(W_t, Q_v, V, P_d, d_P, N):
    ...
    K_v = dynamic_factor(V)                       # dynamic factor
    K_s = 1                      # size factor
    # V is
    # P_d is transverse diameteral pitch
    F = 1.5                        # face width of narrow member
    K_m = load_distribution_factor(d_P, F)                       # load-distribution factor
    ...
    S_F =                   # AGMA bending factor of safety, a stress ratio
    ...
    S_H =                          # AGMA wear factor of safety, a stress ratio

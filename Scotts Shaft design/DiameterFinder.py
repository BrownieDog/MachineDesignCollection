...
FullyReversedBendingMoment = eval(input("Enter the fully reversed bending moment: "))
SteadyTorque = eval(input("Enter the steady torque: "))
...
loopvar = True
while loopvar == True:
    print("What is the Stress concentrator?")
    print("1. Sharp Radius")
    print("2. Wide Radius")
    print("3. Keyway")
    print("4. Retaining Ring Groove")
    menuSelect = eval(input("Enter the number of the stress concentrator: "))
    if menuSelect ==1:
        Kt=2.7
        Kts=2.2
